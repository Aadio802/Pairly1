"""
Match selection algorithm with scoring system
Score = 100 + bonuses
"""
...
async def find_best_match(user_id: int, my_gender: str, gender_pref: Optional[str] = None) -> Optional[int]:
    """
    ...
    # Get candidates
    candidates = await get_waiting_candidates(user_id, my_gender)
    ...
    for candidate in candidates:
        ...
        score = calculate_match_score(
            {
                'is_premium': bool(candidate['is_premium']),
